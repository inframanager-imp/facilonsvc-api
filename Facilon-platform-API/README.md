...
java -DSERVICE_1_PORT=9090 -DSERVICE_1_NAME=user-management-service -DAZURE_AD_ISSUER_NAME=facilonservices -DAZURE_FORCE_RESET_PASSWORD=true -jar target/azure-user-management-1.0.0-SNAPSHOT.jar
